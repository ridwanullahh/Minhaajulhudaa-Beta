...
export const GET: APIRoute = async ({ request, url }) => {
  ...
  try {
    ...
    if (id) {
      const doc = await lightbase.getById('charity_blog_posts', id);
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    ...
    body.authorEmail = body.authorEmail || session.email;
    ...
    const result = await lightbase.insert('charity_blog_posts', body);
...
export const PATCH: APIRoute = async ({ request, url }) => {
  ...
  try {
    ...
    const result = await lightbase.update('charity_blog_posts', id, body);
...
export const DELETE: APIRoute = async ({ request, url }) => {
  ...
  try {
    ...
    await lightbase.delete('charity_blog_posts', id);
